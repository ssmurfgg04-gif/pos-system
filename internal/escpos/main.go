// Package escpos is a vendored, trimmed copy of github.com/hennedo/escpos
// v0.0.1 (MIT License, (c) 2021 Hendrik Fellerhoff). Local changes: the
// CGO-dependent iconv functions (WriteGBK/WriteWEU) were removed so the
// whole binary builds with CGO_ENABLED=0 for every desktop platform.
package escpos
